...
const TOPICS = [
  {
    ...
    body: [
      ...
      { h: 'Activity & requests', p: 'Tap the heart (top-right, like Instagram) to open Activity. Message requests, likes, comments, colleague requests and calls all live there. Accept, delete, or block a request without it entering your main inbox. Tap the +one wordmark in the top-left to see your own profile.' },
