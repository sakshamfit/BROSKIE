...
const TOPICS = [
  {
    ...
    body: [
      ...
      { h: 'Activity & requests', p: 'Tap the heart (top-right, like Instagram) to open Activity. Message requests, likes, comments, colleague requests and calls all live there. Accept, delete, or block a request without it entering your main inbox. Tap the +one wordmark in the top-left to see your own profile (or Settings → My public profile).' },
      ...
      { h: 'Replies & reactions', p: 'On a phone, swipe a message right to reply — it follows your finger, a ↩ appears, and releasing past the threshold opens the composer on that message. Long-press for Reply, react, or delete. On desktop, hover a message and click ↩, choose Reply from the menu, or press R. Tap a quoted reply to scroll back to the original.' },
      ...
      { h: 'Recent, archived and requests', p: 'At the top of Chats, tap Recent Chat to switch the whole list between Recent Chat, Archived Chat, and Request Chat. Switching only changes what you see — it does not archive or unarchive anything. Incoming chat requests stay in Request Chat until you accept or decline them. GCs never appear here.' },
  ...
  },
  {
    ...
    body: [
      ...
      { h: 'Liking & commenting', p: 'Tap the Instagram-style heart to like a post (it fills red when liked), or the speech bubble to open comments. Likes on your posts appear in Activity when you tap the top-right heart. Tap any #tag chip (yours or someone else\u2019s) to filter the feed to just that tag.' },
  ...
  },
  {
    ...
    body: [
      ...
      { h: 'Viewing your public profile', p: 'Tap the +one wordmark in the top-left on any main tab, or open Settings → My public profile, to see exactly what other +ones see when they open you. From there you can edit your information too.' },
